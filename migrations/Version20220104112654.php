 ...
 */
final class Version20220104112654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question_bddcooking ADD user_id INT DEFAULT NULL, ADD validate TINYINT(1) NOT NULL');
